...
NDiplomacy = {
	...
	DEMESNE_MAX_SIZE_KING_MULT = 1.0,			-- Extra Max Demesne Size from the ruler's rank
	DEMESNE_MAX_SIZE_EMPEROR_MULT = 1.0,		-- Extra Max Demesne Size from the ruler's rank
	...
	DEMESNE_BONUS_MAX_TECH_EMPEROR = 19,
	DEMESNE_BONUS_MAX_TECH_KING = 17,
...
NCharacter = {
	...
	CHANGE_SUCC_LAW_YEARS = 25,						-- Rulers must have reigned this long before they can change succession laws
	...
	RAISED_TROOPS_VASSAL_OPINION_DAYS = 41,			-- After 61 days of having their troops raised, vassals will get -1 opinion more of you
...
NMilitary = {
	...
	MERCENARY_MAINTENANCE_FACTOR = 5.0,				-- Maintenance factor for NORMAL mercenary units
	...
	RETINUE_REINFORCE_COST = 0.2,					-- Retinues cost while reinforcing.
